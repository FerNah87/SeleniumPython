...
btn_send=driver.find_element_by_xpath("//button[@type='submit'][contains(.,'Send')]")
btn_send.click()
time.sleep(t)

nombre_valid=driver.find_element_by_xpath("//small[@class='help-block'][contains(.,'Please supply your first name')]")
name=nombre_valid.text
#print("el valor del error es: " + name)
if(name=="Please supply your first name"):
    nombre=driver.find_element_by_xpath("//input[contains(@name,'first_name')]")
...
apellido_valid=driver.find_element_by_xpath("//small[@class='help-block'][contains(.,'Please supply your last name')]")
apellido=apellido_valid.text
if(apellido=="Please supply your last name"):
    apellido=driver.find_element_by_xpath("//input[contains(@name,'last_name')]")
...
email_valid=driver.find_element_by_xpath("//small[@class='help-block'][contains(.,'Please supply your email address')]")
