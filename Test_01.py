...
time.sleep(2)
#es la otra forma
driver.find_element("xpath","//*[@id='currentAddress']").send_keys("Hurlingham")
time.sleep(2)
driver.find_element("xpath","//*[@id='permanentAddress']").send_keys("Villa Tesei")
time.sleep(2)
